import { LoggerModel } from "../../http/models";
...
/**
 * Servicio de Logger
 * Maneja la lógica de negocio relacionada con logs/historial
 * Proporciona persistencia y consulta de logs del sistema
 * 
 * Este servicio es reutilizable desde cualquier parte del sistema.
...
class LoggerService {
     ...
     * 
     * Ejemplo de uso desde TelemetryService:
     * ```typescript
    ...
    public static async createLog(
        ...
        await loggerService.save(logData);
    }
